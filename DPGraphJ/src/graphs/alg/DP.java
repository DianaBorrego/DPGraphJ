...
//import hypergraphs.SimpleVirtualHyperGraph;


public class DP<V extends HyperVertex<V,E,A,S>, E extends HyperEdge<V,E,A,S>,A,S> {


//	public enum PDType{Min,Max}

//	public SimpleVirtualHyperGraph<V,E,A,S> graph;
...
//	DP(SimpleVirtualHyperGraph<V,E,A,S> graph, PDType type) {
//		this.graph = graph;
...
//	public SimpleVirtualHyperGraph<V, E, A, S> getGraph() {
//		return graph;
//	}
...
//	public GraphTree2<V,E,A,S> searchTree(V vertex){
//		return GraphTree2.of(this.solutionsTree,vertex);
//	}

//	public static <V extends HyperVertex<V, E, A, S>, E extends HyperEdge<V, E, A, S>, A, S>
//		DP<V, E, A, S> dynamicProgrammingSearch(
//			SimpleVirtualHyperGraph<V, E, A, S> graph,
//			PDType type) {
//		return new DP<>(graph, type);
//	}
	
	/**
	 * Partial solution computed from a specific edge of the virtual problem solving graph.
	 * Its fields represent the weight of the partial solution for the concrete edge.
	 *
